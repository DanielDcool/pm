				...
				<div class="tab-content profile-edit-tab-content">
					<div id="edit-basic" class="tab-pane active">
							...
							<div class="col-sm-9">
								<div class="input-medium">
									<div class="input-group">
										<input class="input-medium date-picker" id="birthday" value="${(info.birthday?string('yyyy-MM-dd'))!}"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<label class="inline"> <input name="gender"  <#if (info.gender!0)==0>checked="checked"</#if> 
									type="radio" class="ace" value=0> <span class="lbl middle">
										男</span>
								</label> &nbsp; &nbsp; &nbsp; <label class="inline"> <input  <#if (info.gender!0)==1>checked="checked"</#if> 
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="input-large" type="text" id="graduateSchool" value="${(info.graduateSchool)! }"
										 value="Alex"> 
							</div>
						</div>
						...
						<h4 class="header blue bolder smaller">人事信息</h4>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="salary">薪资</label>
								<div class="col-sm-9">
									<input class="input-smal" type="text" id="salary" value="${(info.salary?string(',###.00'))!} "
											 value="Alex"> 
								</div>
							</div>
							...
							<div class="col-sm-9">
								<div class="input-medium">
									<div class="input-group">
										<input class="input-medium date-picker" id="employmentDate" value="${(info.employmentDate?string('yyyy-MM-dd'))!}"
											type="text" data-date-format="yyyy-mm-dd"
											placeholder="yyyy-mm-dd"> <span
											class="input-group-addon"> <i
											class="ace-icon fa fa-calendar"></i>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input-medium">
										<div class="input-group">
											<input class="input-medium date-picker" id="separationDate" value="${(info.separationDate?string('yyyy-MM-dd'))!}"
												type="text" data-date-format="yyyy-mm-dd"
												placeholder="yyyy-mm-dd"> <span
												class="input-group-addon"> <i
												class="ace-icon fa fa-calendar"></i>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input-medium">
										<div class="input-group">
											<input class="input-medium date-picker" id="regularDate"  value="${(info.regularDate?string('yyyy-MM-dd'))!}"
												type="text" data-date-format="yyyy-mm-dd"
												placeholder="yyyy-mm-dd"> <span
												class="input-group-addon"> <i
												class="ace-icon fa fa-calendar"></i>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input-medium">
										<div class="input-group">
											<input class="input-medium date-picker" id="ontractStartDate" value="${(info.ontractStartDate?string('yyyy-MM-dd'))!}"
												type="text" data-date-format="yyyy-mm-dd"
												placeholder="yyyy-mm-dd"> <span
												class="input-group-addon"> <i
												class="ace-icon fa fa-calendar"></i>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input-medium">
										<div class="input-group">
											<input class="input-medium date-picker" id="ontractEndDate" value="${(info.ontractEndDate?string('yyyy-MM-dd'))!}"
												type="text" data-date-format="yyyy-mm-dd"
												placeholder="yyyy-mm-dd"> <span
												class="input-group-addon"> <i
												class="ace-icon fa fa-calendar"></i>
...
${(info.name)! } </@mainContainerLayout.layout>
