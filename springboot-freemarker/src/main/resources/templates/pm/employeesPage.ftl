...
<form class="form-inline">
   ...
   <div class="col-xs-12 widget-box widget-color-blue2">
				...
				$("#searchForm").click(function(){
	                ...
	                $(grid_selector).jqGrid("setGridParam",
	                        {url:"/pm/employees?id="+ id +
	                                "&name="+name+
	                                "&position="+position+
	                                "&department="+department, page:1, datatype:"json"}).trigger("reloadGrid"); 
				})
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'employmentDate',index:'employmentDate', width:90,sorttype:"date",unformat: pickDate,formatter:"date",formatoptions: {srcformat:'u',newformat:'Y-m-d'}},
						{name:'regularDate',index:'regularDate',width:90,sorttype:"date",unformat: pickDate,formatter:"date",formatoptions: {srcformat:'u',newformat:'Y-m-d'}},
						{name:'salary',index:'salary',width:90,formatter:'currency', formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "¥ "}}
					], 
			...
			jqnav.navButtonAdd(pager_selector, {  
               ...
               onClickButton: function () {  
                  ...
                  if(id==null||id==""){
					...
					window.open ('employee?oper=add&id='+id,'newwindow','height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=yes,location=no, status=no'); 
                  }
               },  
               position: "first"  
           }) 
           ...
           jqnav.navButtonAdd(pager_selector, {  
               ...
               onClickButton: function () {  
            	   window.open ('employee?oper=add','newwindow','height=500,width=1000,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=yes,location=no, status=no'); 
               },  
               position: "first"  
           }) 
           	//查看
